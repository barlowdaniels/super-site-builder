...
?>
<div class="container-fluid key_point_block <?= \SuperBuilder\Frontend\FlexibleContentBlock::blockClasses();?>">
    <div class="row">
        <div class="col-1"></div>
            ...
            <div class="row">
                <div class="col col-12 col-lg-6 circle">
                    <div class="block-wrapper">
                        ...
                        <?= \SuperBuilder\Frontend\FlexibleContentBlock::blockButton($circle['button']); ?>
                    </div>
